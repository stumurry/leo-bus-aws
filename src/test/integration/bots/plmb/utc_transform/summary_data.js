...
module.exports = (opts) => {
  ...
  const sampleInput3 = {
    ...
    period: {
      id: '1235',
      description: '2Q 2019',
      start_date: '08/01/2019 12:00AM',
      end_date: '08/31/2019 11:59PM',
      type: {
        id: 1,
        description: 'Weekly'
      }
  ...
  const expectedOutput3 = {
    ...
    period: {
      id: '1235',
      description: '2Q 2019',
      start_date: '2019-08-01 06:00:00',
      end_date: '2019-09-01 05:59:00',
      type: {
        id: 1,
        description: 'Weekly'
      }
  ...
  beforeEach(async () => {
    bot = opts.getBot('plmb/utc_transform/summary_data')
  })
