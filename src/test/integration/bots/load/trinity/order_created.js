...
module.exports = (opts) => {
  ...
  const sampleMappings = {
    ...
    in1: {
      ...
      dealer_id: '1034',
      dealership_id: '5679',
      tracking_number: 'z10345',
      order_date: '2018-01-01 10:30:00',
      personal_volume: '65',
      commission_volume: '40',
      retail_value: '110.00',
      wholesale_value: '101.00',
      autoship_template_id: '12345',
      items: [{
        sku: 'p1243z6',
        name: 'Whatzit 1',
  ...
  beforeEach(async () => {
    bot = opts.getBot('load/trinity/order_created')
  })
